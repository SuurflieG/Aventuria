    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (pStack.getItem() instanceof UpgradeCardItem) {
            if (upgradeCard == Upgrade.SILK)
                pTooltipComponents.add(new TranslatableComponent("aventuria.tooltip.upgrades.silk_touch").withStyle(ChatFormatting.GREEN));
            if (upgradeCard == Upgrade.FORTUNE_1)
                pTooltipComponents.add(new TranslatableComponent("aventuria.tooltip.upgrades.fortune_1").withStyle(ChatFormatting.GREEN));
            if (upgradeCard == Upgrade.FORTUNE_2)
                pTooltipComponents.add(new TranslatableComponent("aventuria.tooltip.upgrades.fortune_2").withStyle(ChatFormatting.GREEN));
            if (upgradeCard == Upgrade.FORTUNE_3)
                pTooltipComponents.add(new TranslatableComponent("aventuria.tooltip.upgrades.fortune_3").withStyle(ChatFormatting.GREEN));
