...
public class BlockOverlayRender {
    ...
    public static void render(RenderLevelLastEvent event, ItemStack item) {
        ...
        int range = ToolMiningProperties.getBeamRange(item);
        ...
        List<BlockPos> coords = MiningCollect.collect(mc.player, lookingAt, mc.level, ToolMiningProperties.getRange(item));
