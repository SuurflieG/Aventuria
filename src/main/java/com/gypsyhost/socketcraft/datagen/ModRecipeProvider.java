...
import com.gypsyhost.socketcraft.datagen.custom.CatalyzerRecipeBuilder;
import com.gypsyhost.socketcraft.registry.ModBlocks;
import com.gypsyhost.socketcraft.registry.ModHandleItems;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        new CatalyzerRecipeBuilder(ModItems.GEM_RAW_AVENTURINE.get(), ModItems.GEM_RAW_AVENTURINE.get(), ModItems.GEM_RAW_AVENTURINE.get(), ModItems.GEM_RAW_AVENTURINE.get(), ModItems.CATALYST.get(), ModItems.GEM_AVENTURINE.get(), 1,200)
        ...
        new CatalyzerRecipeBuilder(ModItems.GEM_RAW_CALCITE.get(), ModItems.GEM_RAW_CALCITE.get(), ModItems.GEM_RAW_CALCITE.get(), ModItems.GEM_RAW_CALCITE.get(), ModItems.CATALYST.get(), ModItems.GEM_CALCITE.get(), 1,200)
        ...
        new CatalyzerRecipeBuilder(ModItems.GEM_RAW_PYRITE.get(), ModItems.GEM_RAW_PYRITE.get(), ModItems.GEM_RAW_PYRITE.get(), ModItems.GEM_RAW_PYRITE.get(), ModItems.CATALYST.get(), ModItems.GEM_PYRITE.get(), 1,200)
        ...
        new CatalyzerRecipeBuilder(ModItems.GEM_RAW_RUBY.get(), ModItems.GEM_RAW_RUBY.get(), ModItems.GEM_RAW_RUBY.get(), ModItems.GEM_RAW_RUBY.get(), ModItems.CATALYST.get(), ModItems.GEM_RUBY.get(), 1,200)
        ...
        new CatalyzerRecipeBuilder(ModItems.GEM_RAW_TOPAZ.get(), ModItems.GEM_RAW_TOPAZ.get(), ModItems.GEM_RAW_TOPAZ.get(), ModItems.GEM_RAW_TOPAZ.get(), ModItems.CATALYST.get(), ModItems.GEM_TOPAZ.get(), 1,200)
        ...
        new CatalyzerRecipeBuilder(ModItems.GEM_RAW_UNAKITE.get(), ModItems.GEM_RAW_UNAKITE.get(), ModItems.GEM_RAW_UNAKITE.get(), ModItems.GEM_RAW_UNAKITE.get(), ModItems.CATALYST.get(), ModItems.GEM_UNAKITE.get(), 1,200)
        ...
        //region Tool Handle Recipes
        ShapedRecipeBuilder.shaped(ModHandleItems.WOOD.get())
                .define('S', Items.STICK)
                .pattern("  S")
                .pattern(" S ")
                .pattern("S  ")
                .unlockedBy("has_stick", inventoryTrigger(ItemPredicate.Builder.item().of(ModHandleItems.WOOD.get()).build()))
                .save(pFinishedRecipeConsumer);
        //endregion
